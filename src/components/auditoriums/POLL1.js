...
class PublicPoll extends Component {
    ...
    suscribeToPollAdmin = () => 
    {
        ...
        console.log(AppString.PollAdmin_Col);
        console.log(AppString.PollAdmin_Doc1);
        this.removeListener = this.context.db.collection(AppString.PollAdmin_Col).doc(AppString.PollAdmin_Doc1).onSnapshot(
                doc => {
    ...
    getPolls = async () => {
        try {
            this.pollDocData = [];
            const snapshots = await this.context.db.collection(AppString.Poll_Doc1).get();
    ...
    sendPollFeedback = (pollId, optionNumber) => {
        var pollDocRef = this.context.db.collection(AppString.Poll_Doc1).doc(pollId);
...
export default PublicPoll;
   ...
   {/* <div className="poll-section__block">
                                <h3 className="poll-section__title mg-b20">Q1. HOW TO DESIGN A VIRTUAL EVENT?</h3>
                                <label className="custom-radio">
