...
v1="https://storage.googleapis.com/virtual-event-273009.appspot.com/PRAVEN/WDV2Nov/Client%20Devices/WD_ColorCampaign_Video.mp4?autoplay=1";

const auth = firebase.auth();
const rdbx = firebase.database();
var stallName = 'Client+';
