var CssManager = pc.createScript('cssManager');


CssManager.attributes.add('css', {type: 'asset', assetType:'css', title: 'CSS Asset'});

CssManager.prototype.initialize = function () {
...
CssManager.prototype.attachAsset = function(assetId, fn) {
...
CssManager.prototype.template = function(asset, css) {
...
CssManager.prototype.update = function (dt) {
