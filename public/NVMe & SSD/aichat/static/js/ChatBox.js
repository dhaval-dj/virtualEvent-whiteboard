...
let saveMyLastMenu = messages[1];
 class ChatBox {
    constructor(botReply, user) {
        this.robot = { id: '1', name: 'NVMe & SSD', img: 'https://storage.googleapis.com/virtual-event-273009.appspot.com/PRAVEN/WDV2Nov/chat-speech-circle%20icon.png' };
        ...
        <section class="msger">
            <header class="msger-header">
                <div class="msger-header-title">
                    <i class="fas fa-comment-alt"></i>NVMe & SSD- ASK US
                </div>
