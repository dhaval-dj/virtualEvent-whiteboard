...
class ChatBox {
    constructor(botReply, user) {
        this.robot = { id: '1', name: 'GAMING', img: 'https://storage.googleapis.com/virtual-event-273009.appspot.com/PRAVEN/WDV2Nov/chat-speech-circle%20icon.png' };
        ...
        <section class="msger">
            <header class="msger-header">
                <div class="msger-header-title">
                    <i class="fas fa-comment-alt"></i>GAMING- ASK US
                </div>
